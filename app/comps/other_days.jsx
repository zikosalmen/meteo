  ...
  return (
    ...
    >
      ...
      {donne.map((e, indx) => (
        <div
          key={indx}
          className={`rounded-4xl min-w-[380px] max-h-[200px]  grid grid-cols-3 gap-4 p-4 
            ${
              dark
                ? `bg-gray-700/30 text-slate-300`
                : `bg-blue-300/30 text-slate-800`
            }`}
        >
          ...
          <div className={`${dark ? `text-white` : `text-stone-800`}`}>
            <div className="flex text-3xl items-center gap-1 ">
              {e.temp_max} <p className="text-xl">{t("c")}</p>
              <Image
            ...
            <div className="flex text-3xl items-center gap-1 ">
              {e.temp_min} <p className="text-xl">{t("c")}</p>
              <Image
